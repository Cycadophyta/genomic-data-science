...
- The index can then be queried by searching for the first _k_ characters in the index, then the next positions are searched for the next characters.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1Nzg4MDM3MCwxNzgyMzQ4NTE2XX0=
-->