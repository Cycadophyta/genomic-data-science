...
- To index a genome, it must first be broken down into substrings, which are ordered alphabetically and the position(s) recorded.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYyNDc5Mzc3OSwxNzgyMzQ4NTE2XX0=
-->