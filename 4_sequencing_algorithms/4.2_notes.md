...
- Instead of building an idex from substrings, subsequences can be used. 
	- Subsequences are strings of characters in the sequence, but not necessarily one after the other.
- The same 'shape' must be used.
- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4Mzk0MjQ3MSw3MTQxNzA3ODcsNzAxMT
