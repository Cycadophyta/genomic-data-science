...
- Each nucket contains a list of the kmer, position and a null value.
- There are more kmers than buckets, so some kmers end up in the same buckets (this is the pigeonhole principle).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDc0NDI5NDUsLTQxNTY4NzEyNywtMT
Q0NzI0NzI2NCwtMTUzMDU4NzM5OSwxNzg1NDQ2NTkwLDE3NDA2
MzYxNzksMTc4MjM0ODUxNl19
-->